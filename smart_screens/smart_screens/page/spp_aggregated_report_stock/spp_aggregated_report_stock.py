"""
SPP Aggregated Stock Report (No Valuation)
...
report_name="SPP Aggregated Stock Report",
...
user=frappe.session.user
		...
		t3 = time.time()
		all_data, excluded_count = exclude_batches(all_data, "SPP Aggregated Stock Report")
		t4 = time.time()
...
"""
	...
	try:
		...
		# Exclude batches
		all_batches_data, excluded_count = exclude_batches(all_batches_data, "SPP Aggregated Stock Report")
...
report_title="SPP Aggregated Stock Report",
filters=filters,
warehouse_filter=warehouse,
